...
import arrowImage from "../assets/arrow-right.png";  // Static import for arrow image
import likeIcon from "../assets/Icon@2x.png";       // Static import for like icon
  ...
  return (
    <Box>
      <Box className="item" component="section" mt={2}>
        <Typography>Products Recommendation</Typography>
        <Button
          variant="contained"
          ...
          <Box key={i}>
            <Paper className="product" elevation={0}>
              ...
              <Box
                ...
                alt={product.name}  // Always add alt attribute for accessibility
              />
              <Typography
                gutterBottom
                variant="h5"
